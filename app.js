...
const DEFAULT_TAGS = [
  { id: "tag-meat", name: "肉食", color: "pink" },
  { id: "tag-heavy", name: "重口", color: "yellow" },
  { id: "tag-quick", name: "快吃", color: "blue" },
  { id: "tag-light", name: "清爽", color: "green" },
  { id: "tag-safe", name: "安全牌", color: "blue" },
  { id: "tag-ritual", name: "仪式感", color: "orange" },
  { id: "tag-happy", name: "快乐", color: "pink" },
  { id: "tag-hot", name: "热乎", color: "yellow" },
  { id: "tag-western", name: "西式", color: "green" },
];
